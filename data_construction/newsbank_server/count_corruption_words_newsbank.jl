...
corruption_words = [
  ...
  r"nepotism"i,
  r"patronage"i,
  r"conflict of interest"i,
  r"rent seeking"i,
  r"influence peddling"i,
  r"favoritism"i,
  r"abuse",
  r"harassment"i,
  r"misconduct"i,
...
local_titles = [r"mayor"i,
                r"council ?person"i,
                r"council ?(wo)?man"i,
                r"council ?member"i,
                r"state (sen(ator|\.)|rep(resentative|\.))"i,
                r"governor"i,
                r"alderman"i,
                r"commissioner"i,
                r"(city|county) manager"i,
                r"county judge"i,
                r"district attorney"i,
                r"attorney general"i]
...
@threads for f in loop_folders
  count_mentions_in_dir(f, vcat(corruption_words, local_titles))
end
...
joined_file = "$local_dir/newsbank_corruption_localtitle_mentions.csv"
